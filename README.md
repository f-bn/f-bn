...
* :wrench: I'm working mostly with Linux, automating my work with [Ansible](https://www.ansible.com/), using some virtualization and containers techs ([LXD](https://linuxcontainers.org/lxd/introduction/)) but also databases such as [PostgreSQL](https://www.postgresql.org/) (and a spice of [GreenplumDB](https://greenplum.org/) at work)
* :tea: Tea lover
